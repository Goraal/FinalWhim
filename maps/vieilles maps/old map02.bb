...
ciel=					CreerMur(0.01,80,80,		27,HAUTEUR_PLAFOND#*10,16.5,				tex_plafond_ciel$,80)
...
mur_ouest_boite_au_lettre=		CreerMur(0.01,HAUTEUR_PLAFOND#,12,					0,HAUTEUR_PLAFOND#/2,6,								tex_mur_garage$,2)
mur_est_boite_au_lettre=		CreerMur(0.01,HAUTEUR_PLAFOND#,8,					4,HAUTEUR_PLAFOND#/2,8,								tex_mur_garage$,2)
mur_sud_boite_au_lettre=		CreerMur(11,HAUTEUR_PLAFOND#,0.01,					5.5,HAUTEUR_PLAFOND#/2,0,							tex_mur_garage$,2)
...
mur_sud1_couloir=				CreerMur(4,HAUTEUR_PLAFOND#,0.01,			6,HAUTEUR_PLAFOND#/2,4,							tex_mur_garage$,2 )
mur_est1_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#,10,			11,HAUTEUR_PLAFOND#/2,5,						tex_mur_garage$,2 )
mur_ouest12_couloir_temp=		CreerMur(0.01,HAUTEUR_PLAFOND#,8.16,		8,HAUTEUR_PLAFOND#/2,8.08,						tex_mur_garage$,2 )
mur_ouest3_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#,5.1,			8,HAUTEUR_PLAFOND#/2,17.47,						tex_mur_garage$,2 )
sur_mur_ouest23_couloir=		CreerMur(0.01,HAUTEUR_PLAFOND#-2.7,3.5,		7.99,HAUTEUR_PLAFOND#/2+1.35,13.5,				tex_mur_garage$,2 )
mur_nord1_couloir=				CreerMur(2,HAUTEUR_PLAFOND#,0.01,			12,HAUTEUR_PLAFOND#/2,20,						tex_mur_garage$,2 )
mur_nord2_couloir=				CreerMur(1,HAUTEUR_PLAFOND#,0.01,			8.5,HAUTEUR_PLAFOND#/2,20,						tex_mur_garage$,2 )
;mur_ouest4_couloir=			CreerMur(0.01,HAUTEUR_PLAFOND#,2,			14,HAUTEUR_PLAFOND#/2,9,						tex_mur_garage$,2 )
mur_ouest5_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#,2,			13,HAUTEUR_PLAFOND#/2,21,						tex_mur_garage$,2 )
mur_ouest6_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#,1,			11,HAUTEUR_PLAFOND#/2,10.5,						tex_mur_garage$,2 )


plafond_centre1_couloir=		CreerMur(0.01,5,10,						10.5,HAUTEUR_PLAFOND#,15,			tex_plafond_accueil$)
plafond_centre2_couloir=		CreerMur(0.01,5,10,						10.5,HAUTEUR_PLAFOND#,5,				tex_plafond_accueil$)
plafond_centre3_couloir=		CreerMur(0.01,4,4,						6,HAUTEUR_PLAFOND#,2,				tex_plafond_accueil$)
...
mur_nord3_couloir=				CreerMur(2.5,HAUTEUR_PLAFOND#+H_step#,0.01,			19.25,(HAUTEUR_PLAFOND#+H_step#)/2,27,				tex_mur_garage$,2 )
mur_nord_sur_porte1_couloir=	CreerMur(1,HAUTEUR_PLAFOND#-2,0.01,					21,2+H_step#+(HAUTEUR_PLAFOND#-2)/2,27,				tex_mur_garage$,2 )
mur_nord4_couloir=				CreerMur(10,HAUTEUR_PLAFOND#+H_step#,0.01,			26.5,(HAUTEUR_PLAFOND#+H_step#)/2,27,					tex_mur_garage$,2 )
mur_nord_sur_porte2_couloir=	CreerMur(1,HAUTEUR_PLAFOND#-2,0.01,					32,2+H_step#+(HAUTEUR_PLAFOND#-2)/2,27,				tex_mur_garage$,2 )
mur_nord5_couloir=				CreerMur(3.5,HAUTEUR_PLAFOND#+H_step#,0.01,			34.25,(HAUTEUR_PLAFOND#+H_step#)/2,27,				tex_mur_garage$,2 )

mur_sud2_sur_porte3_couloir=	CreerMur(1,HAUTEUR_PLAFOND#-2,0.01,					21.5,HAUTEUR_PLAFOND#/2+H_step#+1,6,				tex_mur_garage$,2 )
mur_sud2_couloir=				CreerMur(14,HAUTEUR_PLAFOND#+H_step#,0.01,			29,(HAUTEUR_PLAFOND#+H_step#)/2,6,				tex_mur_garage$,2 )
mur_sud3_couloir=				CreerMur(3,HAUTEUR_PLAFOND#+H_step#,0.01,			19.5,(HAUTEUR_PLAFOND#+H_step#)/2,6,				tex_mur_garage$,2 )

mur_est2_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#+2*H_step#,5,			41,HAUTEUR_PLAFOND#/2+H_step#,13.5,				tex_mur_garage$,2 )
mur_est3_couloir=				CreerMur(0.01,HAUTEUR_PLAFOND#+2*H_step#,5,			41,HAUTEUR_PLAFOND#/2+H_step#,19.5,				tex_mur_garage$,2 )
mur_est_sur_porte_couloir=		CreerMur(0.01,HAUTEUR_PLAFOND#-2,1,					41,H_step#*2+HAUTEUR_PLAFOND#/2+1,16.5,			tex_mur_garage$,2 )
mur_est_sous_porte_couloir=		CreerMur(0.01,2*H_step#,1,							41,H_step#,16.5,								tex_mur_garage$,2 )
mur_nord_est_couloir=			CreerMur(7.07,HAUTEUR_PLAFOND#+2*H_step#,0.01,		38.5,HAUTEUR_PLAFOND#/2+H_step#,24.5,			tex_mur_garage$,2 )
mur_nord_ouest_couloir=			CreerMur(7.07,HAUTEUR_PLAFOND#+H_step#,0.01,		15.5,(HAUTEUR_PLAFOND#+H_step#)/2,24.5,			tex_mur_garage$,2 )
mur_sud_est_couloir=			CreerMur(7.07,HAUTEUR_PLAFOND#+2*H_step#,0.01,		38.5,HAUTEUR_PLAFOND#/2+H_step#,8.5,			tex_mur_garage$,2 )
mur_sud_ouest_couloir=			CreerMur(7.07,HAUTEUR_PLAFOND#+H_step#,0.01,		15.5,(HAUTEUR_PLAFOND#+H_step#)/2,8.5,				tex_mur_garage$,2 )
...
mur_nord1_uc=						CreerMur(19,HAUTEUR_PLAFOND#+2*H_step#,0.01,		45.5,HAUTEUR_PLAFOND#/2+H_step#,27,			tex_mur_usine$,3)
mur_sud1_uc=						CreerMur(34,HAUTEUR_PLAFOND#+2*H_step#,0.01,		38,HAUTEUR_PLAFOND#/2+H_step#,0,			tex_mur_usine$,3)
mur_nord2_uc=						CreerMur(14,HAUTEUR_PLAFOND#+2*H_step#,0.01,		29,HAUTEUR_PLAFOND#/2+H_step#,5.99,			tex_mur_usine$,3)
mur_nord2_sur_porte_uc=				CreerMur(1,HAUTEUR_PLAFOND#+H_step#-2,0.01,			21.5,HAUTEUR_PLAFOND#/2+H_step#*1.5+1,5.99,			tex_mur_usine$,3)
mur_nord2_sous_porte_uc=			CreerMur(1,H_step#,0.01,							21.5,H_step#/2,5.99,							tex_mur_usine$,3)

mur_ouest1_uc=						CreerMur(0.01,HAUTEUR_PLAFOND#+2*H_step#,5,			41.01,HAUTEUR_PLAFOND#/2+H_step#,13.5,		tex_mur_usine$,3)
mur_ouest2_uc=						CreerMur(0.01,HAUTEUR_PLAFOND#+2*H_step#,5,			41.01,HAUTEUR_PLAFOND#/2+H_step#,19.5,		tex_mur_usine$,3)
...
porte_ouest_uc=						CreerMur(0.2,2,1,									41.0,1+H_step#*2,16.5,							tex_porte_uc$,1)
...
;POSITION DES PORTE FERMEE
;PositionEntity porte_ouest_uc,41.0,1+H_step#*2,15.5
;PositionEntity porte_ouest2_uc,27.9,HAUTEUR_PLAFOND#*1/4+H_step#*0.5,1.5
;PositionEntity porte_nord_uc,22.5,H_step#+1,6

mur_ouest_sur_porte_uc=				CreerMur(0.01,HAUTEUR_PLAFOND#-2,1,					41.01,HAUTEUR_PLAFOND#/2+2*H_step#+1,16.5,		tex_mur_usine$,3)
mur_ouest_sous_porte_uc=			CreerMur(0.01,2*H_step#,1,							41.01,H_step#,16.5,								tex_mur_usine$,3)
...
tapis_roulant_base=					CreerMur(1,3,20,						48,0.5,15,					tex_tapis_roulant$,3,1,				type_block)
tapis_roulant_ext1=					CreerTuyau(0.99,3,						48,0.5,5,					tex_tapis_roulant$,3,0,	 "", 0.98,		type_block)
tapis_roulant_ext2=					CreerTuyau(0.99,3,						48,0.5,25,					tex_tapis_roulant$,3,0,	 "", 0.98,		type_block)
...
passerelle1_uc=						CreerMur(0.01,3,2,		42.5,2*H_step#,16.5,				tex_sol_passerelle$,1,4,		type_block)	
...
passerelle4_uc=						CreerMur(0.01,2,2,		48,2*H_step#+H_stair#*4,12.5,		tex_sol_passerelle$,1,4,		type_block)
passerelle5_uc=						CreerMur(0.01,1,2,		46.5,2*H_step#+H_stair#*2,12.5,		tex_sol_passerelle$,1,4,		type_block)
passerelle6_uc=						CreerMur(0.01,1,2,		49.5,2*H_step#+H_stair#*2,12.5,		tex_sol_passerelle$,1,4,		type_block)
passerelle7_uc=						CreerMur(0.01,2,1,		45,H_step#+H_stair#*6,23,			tex_sol_passerelle$,1,4,		type_block)
passerelle8_uc=						CreerMur(0.01,2,1,		45,H_step#+H_stair#*4,24,			tex_sol_passerelle$,1,4,		type_block)
passerelle9_uc=						CreerMur(0.01,2,2,		45,H_step#+H_stair#*2,25.5,			tex_sol_passerelle$,1,4,		type_block)
passerelle10_uc=					CreerMur(0.01,1,2,		43.5,H_step#,25.5,					tex_sol_passerelle$,1,4,		type_block)
passerelle11_uc=					CreerMur(0.01,1,2,		42.5,H_stair#*6,25.5,				tex_sol_passerelle$,1,4,		type_block)
passerelle12_uc=					CreerMur(0.01,1,2,		41.5,H_stair#*4,25.5,				tex_sol_passerelle$,1,4,		type_block)
passerelle13_uc=					CreerMur(0.01,1,2,		40.5,H_stair#*2,25.5,				tex_sol_passerelle$,1,4,		type_block)
passerelle14_uc=					CreerMur(0.01,4,2,		53,2*H_step#,12.5,					tex_sol_passerelle$,1,4,		type_block)


rebord1_passerelle1_uc=				CreerMur(3,0.5,0.01,	42.5,2*H_step#+0.25,15.5,				tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle1_uc=				CreerMur(3,0.5,0.01,	42.5,2*H_step#+0.25,17.5,				tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle2_uc=				CreerMur(0.01,0.5,5,	44,2*H_step#+0.25,20,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle2_uc=				CreerMur(0.01,0.5,4,	44,2*H_step#+0.25,13.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle2_uc=				CreerMur(0.01,0.5,9,	46,2*H_step#+0.25,18,					tex_sol_passerelle$,1,4,		type_block)
rebord4_passerelle2_uc=				CreerMur(2,0.5,0.01,	45,2*H_step#+0.25,11.5,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle3_uc=				CreerMur(0.01,0.5,13,	50,2*H_step#+0.25,20,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle3_uc=				CreerMur(0.01,0.5,9,	50,2*H_step#+0.25,7,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle3_uc=				CreerMur(0.01,0.5,13,	51,2*H_step#+0.25,20,					tex_sol_passerelle$,1,4,		type_block)
rebord4_passerelle3_uc=				CreerMur(0.01,0.5,9,	51,2*H_step#+0.25,7,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle4_uc=				CreerMur(2,0.5,0.01,	48,2*H_step#+H_stair#*4+0.25,13.5,		tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle4_uc=				CreerMur(2,0.5,0.01,	48,2*H_step#+H_stair#*4+0.25,11.5,		tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle5_uc=				CreerMur(1,0.5,0.01,	46.5,2*H_step#+H_stair#*2+0.25,13.5,	tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle5_uc=				CreerMur(1,0.5,0.01,	46.5,2*H_step#+H_stair#*2+0.25,11.5,	tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle6_uc=				CreerMur(1,0.5,0.01,	49.5,2*H_step#+H_stair#*2+0.25,13.5,	tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle6_uc=				CreerMur(1,0.5,0.01,	49.5,2*H_step#+H_stair#*2+0.25,11.5,	tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle7_uc=				CreerMur(0.01,0.5,1,	44,H_step#+H_stair#*6+0.25,23,			tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle7_uc=				CreerMur(0.01,0.5,1,	46,H_step#+H_stair#*6+0.25,23,			tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle8_uc=				CreerMur(0.01,0.5,1,	44,H_step#+H_stair#*4+0.25,24,			tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle8_uc=				CreerMur(0.01,0.5,1,	46,H_step#+H_stair#*4+0.25,24,			tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle9_uc=				CreerMur(0.01,0.5,2,	46,H_step#+H_stair#*2+0.25,25.5,		tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle9_uc=				CreerMur(2,0.5,0.01,	45,H_step#+H_stair#*2+0.25,26.5,		tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle10_uc=			CreerMur(1,0.5,0.01,	43.5,H_step#+0.25,24.5,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle10_uc=			CreerMur(1,0.5,0.01,	43.5,H_step#+0.25,26.5,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle11_uc=			CreerMur(1,0.5,0.01,	42.5,H_stair#*6+0.25,24.5,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle11_uc=			CreerMur(1,0.5,0.01,	42.5,H_stair#*6+0.25,26.5,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle12_uc=			CreerMur(1,0.5,0.01,	41.5,H_stair#*4+0.25,24.5,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle12_uc=			CreerMur(1,0.5,0.01,	41.5,H_stair#*4+0.25,26.5,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle13_uc=			CreerMur(1,0.5,0.01,	40.5,H_stair#*2+0.25,24.5,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle13_uc=			CreerMur(1,0.5,0.01,	40.5,H_stair#*2+0.25,26.5,					tex_sol_passerelle$,1,4,		type_block)
rebord1_passerelle14_uc=			CreerMur(3,0.5,0.01,	52.5,2*H_step#+0.25,13.5,					tex_sol_passerelle$,1,4,		type_block)
rebord2_passerelle14_uc=			CreerMur(4,0.5,0.01,	53,2*H_step#+0.25,11.5,					tex_sol_passerelle$,1,4,		type_block)

rebord4_passerelle2_uc=				CreerMur(2,H_stair#*2,0.01,			45,H_stair#*15,22.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle4_uc=				CreerMur(0.01,H_stair#*2,2,			47,H_stair#*19,12.5,					tex_sol_passerelle$,1,4,		type_block)
rebord4_passerelle4_uc=				CreerMur(0.01,H_stair#*2,2,			49,H_stair#*19,12.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle5_uc=				CreerMur(0.01,H_stair#*2,2,			46,H_stair#*17,12.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle6_uc=				CreerMur(0.01,H_stair#*2,2,			50,H_stair#*17,12.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle7_uc=				CreerMur(2,H_stair#*2,0.01,			45,H_stair#*13,23.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle8_uc=				CreerMur(2,H_stair#*2,0.01,			45,H_stair#*11,24.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle9_uc=				CreerMur(0.01,H_stair#*2,2,			44,H_stair#*9,25.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle10_uc=			CreerMur(0.01,H_stair#*2,2,			43,H_stair#*7,25.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle11_uc=			CreerMur(0.01,H_stair#*2,2,			42,H_stair#*5,25.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle12_uc=			CreerMur(0.01,H_stair#*2,2,			41,H_stair#*3,25.5,					tex_sol_passerelle$,1,4,		type_block)
rebord3_passerelle13_uc=			CreerMur(0.01,H_stair#*2,2,			40,H_stair#,25.5,					tex_sol_passerelle$,1,4,		type_block)
...
plafond_poste1=						CreerMur(0.01,8,6,					17,HAUTEUR_PLAFOND#-0.01,3,			tex_plafond_poste$,2,1,		type_sol(1,1))
plafond_poste2=						CreerMur(0.01,7.07,7.07,			13,HAUTEUR_PLAFOND#+0.01,6,			tex_plafond_poste$,2,1,		type_sol(1,1))
plafond_poste3=						CreerMur(0.01,2,11,					12,HAUTEUR_PLAFOND#-0.02,5.5,			tex_plafond_poste$,2,1,		type_sol(1,1))
...
sur_porte_poste2=					CreerMur(2,HAUTEUR_PLAFOND#-2,0.01,			12,HAUTEUR_PLAFOND#/2+1,11.01,			tex_mur_garage$,2)
...
;PositionEntity porte_poste,13.7,1.75,11.7
; //0,45,0
...
mur_sud1_sdp=						CreerMur(5.5,HAUTEUR_PLAFOND#,0.01,		28.75,HAUTEUR_PLAFOND#/2+H_step#,27.01,		tex_mur_sdp$,HAUTEUR_PLAFOND#)
mur_sud_sur_porte=					CreerMur(1,HAUTEUR_PLAFOND#-2,0.01,		32,(HAUTEUR_PLAFOND#-2)/2+2+H_step#,27.01,	tex_mur_sdp$,HAUTEUR_PLAFOND#)
mur_sud2_sdp=						CreerMur(3.5,HAUTEUR_PLAFOND#,0.01,		34.25,HAUTEUR_PLAFOND#/2+H_step#,27.01,		tex_mur_sdp$,HAUTEUR_PLAFOND#)
...
plafond_sdp1=						CreerMur(0.01,13,10,					31,HAUTEUR_PLAFOND#+H_step#,33.5,			tex_plafond_accueil$,2,1,		type_sol(1,1))
...
;.infirmerie
logo1_infirmerie=					CollerImage(0,0,0,			21,3.5,26.9,			img_symbole_pharmacie$,1)
ScaleSprite logo1_infirmerie,0.2,0.2
logo2_infirmerie=					CollerImage(0,-90,0,		17.8,2.3,27.5,			img_symbole_pharmacie$,1)
...
mur_ouest1_infirmerie=				CreerMur(0.01,HAUTEUR_PLAFOND#,9.2,		16.9,HAUTEUR_PLAFOND#/2,32.5,			tex_mur_infirmerie$,0.7)
mur_ouest_sur_porte_infirmerie=		CreerMur(0.01,HAUTEUR_PLAFOND#-2,1,		17.91,2+(HAUTEUR_PLAFOND#-2)/2,27.51,	tex_mur_infirmerie$,0.7)
...
mur_sud1_infirmerie=				CreerMur(2.5,HAUTEUR_PLAFOND#,0.01,		19.25,HAUTEUR_PLAFOND#/2,27.01,			tex_mur_infirmerie$,0.7)
mur_sud2_infirmerie=				CreerMur(4.5,HAUTEUR_PLAFOND#,0.01,		23.75,HAUTEUR_PLAFOND#/2,27.01,			tex_mur_infirmerie$,0.7)
mur_sud_sous_porte_infirmerie=		CreerMur(1,H_step#,0.01,				21,H_step#/2,27.01,						tex_mur_infirmerie$,0.7)
mur_sud_sur_porte_infirmerie=		CreerMur(1,HAUTEUR_PLAFOND#-2,0.01,		21,2+(HAUTEUR_PLAFOND#-2)/2+H_step#,27.01,						tex_mur_infirmerie$,0.7)


rampe1_infirmerie=					CreerMur(H_step#,H_step#,H_step#,		21,H_step#/2,27+H_step#/2,				tex_mur_infirmerie$,0.7)
rampe2_infirmerie=					CreerMur(4,H_step#,H_step#,				23.295,-0.03,27.615,				tex_mur_infirmerie$,0.7,1,	type_sol(2,1))
...
PositionEntity lit_infirmerie1,17.5,0.6,36.2
PositionEntity lit_infirmerie2,17.9,0.6,34.3
PositionEntity lit_infirmerie3,18.3,0.6,32.4
PositionEntity lit_infirmerie4,18.7,0.6,30.5
...
plafond1_accueil=				CreerMur(0.01,10,10,		13,HAUTEUR_PLAFOND#,32,				tex_plafond_accueil$,2,1,		type_sol(1,1))
plafond2_accueil=				CreerMur(0.01,5,7,			10.5,HAUTEUR_PLAFOND#,23.5,			tex_plafond_accueil$,2,1,		type_sol(1,1))
plafond3_accueil=				CreerMur(0.01,7.07,7.07,	13,HAUTEUR_PLAFOND#+0.02,27,		tex_plafond_accueil$,2,1,		type_sol(1,1))
...
mur_est1_accueil=				CreerMur(0.01,HAUTEUR_PLAFOND#,9.2,		16.89,HAUTEUR_PLAFOND#/2,32.49,			tex_mur_accueil$,3)
mur_est_sur_porte=				CreerMur(0.01,HAUTEUR_PLAFOND#-2,1,		17.9,2+(HAUTEUR_PLAFOND#-2)/2,27.5,			tex_mur_accueil$,3)
...
mur_sud1_accueil=				CreerMur(2,HAUTEUR_PLAFOND#,0.01,		12,HAUTEUR_PLAFOND#/2,20.01,		tex_mur_accueil$,3)
mur_sud2_accueil=				CreerMur(1,HAUTEUR_PLAFOND#,0.01,		8.5,HAUTEUR_PLAFOND#/2,20.01,		tex_mur_accueil$,3)
...
PositionEntity Teddy,26.7,0.7,2.6
TurnEntity Teddy,0,-30,0
AnimateMD2 Teddy,1,0.1,0,30

;	Protecteur1=LoadMD2("objets\garde\tris.md2")
;	EntityTexture Protecteur1,tex_Garde1
;	ScaleEntity Protecteur1,0.03,0.03,0.03
;	PositionEntity Protecteur1,35.3,2.0,35.2
;	TurnEntity Protecteur1,0,90,0
;	AnimateMD2 Protecteur1,1,0.1,0,20
;	
;	Protecteur2=LoadMD2("objets\garde\tris.md2")
;	EntityTexture Protecteur2,tex_Garde1
;	ScaleEntity Protecteur2,0.03,0.03,0.03
;	PositionEntity Protecteur2,28,2.0,38
;	TurnEntity Protecteur2,0,170,0
;	AnimateMD2 Protecteur2,1,0.1,20,40
;	
;	Protecteur3=LoadMD2("objets\garde\tris.md2")
;	EntityTexture Protecteur3,tex_Garde1
;	ScaleEntity Protecteur3,0.03,0.03,0.03
;	PositionEntity Protecteur3,29.6,2.0,33.2
;	TurnEntity Protecteur3,0,-100,0
;	AnimateMD2 Protecteur3,1,0.1,47,54
;	
;	Stan=LoadMD2("objets\garde\tris.md2")
;	tex_Stan=LoadTexture("objets\garde\Ctf_b.pcx")
;	EntityTexture Stan,tex_Stan
;	ScaleEntity Stan,0.03,0.03,0.03
;	PositionEntity Stan,31.1,2.0,31.4
;	TurnEntity Stan,0,160,0
;	AnimateMD2 Stan,1,0.1,110,120

Cadavre=LoadMD2("objets\manuel\tris.md2")
tex_Cadavre=LoadTexture("objets\manuel\manuel.pcx")
EntityTexture Cadavre,tex_Cadavre
ScaleEntity Cadavre,0.04,0.04,0.04
PositionEntity Cadavre,12,1.0,33
TurnEntity Cadavre,0,160,0
AnimateMD2 Cadavre,1,0.1,189,189
...
;	If bgm<>0 then FreeSound bgm
;	bgm=LoadSound("musiques\WindyCave.mp3") ;chill.mp3
;	If bgm<>0
;		LoopSound bgm
;		ch_bgm=PlaySound(bgm)
;		ChannelVolume ch_bgm,0.5*options#(5)
;		ChannelPan ch_bgm,0
;	EndIf
